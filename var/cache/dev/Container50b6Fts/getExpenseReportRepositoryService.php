...
// Returns the private 'App\Repository\ExpenseReportRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExpenseReportRepository.php';

return $this->privates['App\Repository\ExpenseReportRepository'] = new \App\Repository\ExpenseReportRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
