...
// Returns the private 'App\Repository\ManufacturerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ManufacturerRepository.php';

return $this->privates['App\Repository\ManufacturerRepository'] = new \App\Repository\ManufacturerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
