...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CalendarEventType' => function () {
    return ($this->privates['App\Form\CalendarEventType'] ?? $this->privates['App\Form\CalendarEventType'] = new \App\Form\CalendarEventType());
}, 'App\\Form\\ExpenseReportType' => function () {
    return ($this->privates['App\Form\ExpenseReportType'] ?? $this->privates['App\Form\ExpenseReportType'] = new \App\Form\ExpenseReportType());
}, 'App\\Form\\ManufacturerType' => function () {
    return ($this->privates['App\Form\ManufacturerType'] ?? $this->privates['App\Form\ManufacturerType'] = new \App\Form\ManufacturerType());
