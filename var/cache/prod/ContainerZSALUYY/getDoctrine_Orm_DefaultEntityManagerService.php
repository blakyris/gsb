...
$d->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CalendarEventsRepository' => function () {
    return ($this->privates['App\Repository\CalendarEventsRepository'] ?? $this->load('getCalendarEventsRepositoryService.php'));
}, 'App\\Repository\\DoctorRepository' => function () {
    return ($this->privates['App\Repository\DoctorRepository'] ?? $this->load('getDoctorRepositoryService.php'));
}, 'App\\Repository\\ExpenseReportRepository' => function () {
    return ($this->privates['App\Repository\ExpenseReportRepository'] ?? $this->load('getExpenseReportRepositoryService.php'));
}, 'App\\Repository\\ManufacturerRepository' => function () {
    return ($this->privates['App\Repository\ManufacturerRepository'] ?? $this->load('getManufacturerRepositoryService.php'));
}, 'App\\Repository\\ProductCategoryRepository' => function () {
    return ($this->privates['App\Repository\ProductCategoryRepository'] ?? $this->load('getProductCategoryRepositoryService.php'));
