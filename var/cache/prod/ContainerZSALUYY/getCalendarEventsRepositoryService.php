...
// Returns the private 'App\Repository\CalendarEventsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CalendarEventsRepository.php';

return $this->privates['App\Repository\CalendarEventsRepository'] = new \App\Repository\CalendarEventsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
