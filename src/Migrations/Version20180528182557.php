 ...
 */
class Version20180528182557 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE expense_report CHANGE totalPrice totalPrice DOUBLE PRECISION NOT NULL, CHANGE refundedPortion refundedPortion DOUBLE PRECISION DEFAULT NULL, CHANGE lastStatutUpdate lastStatutUpdate DATE DEFAULT NULL, CHANGE statutUpdateBy statutUpdateBy INT DEFAULT NULL');
