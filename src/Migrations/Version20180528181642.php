 ...
 */
class Version20180528181642 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE calendar_events CHANGE all_day all_day TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE expense_report CHANGE totalPrice totalPrice NUMERIC(7, 2) NOT NULL, CHANGE refundedPortion refundedPortion DOUBLE PRECISION DEFAULT \'NULL\', CHANGE lastStatutUpdate lastStatutUpdate DATE DEFAULT \'NULL\', CHANGE statutUpdateBy statutUpdateBy INT DEFAULT NULL');
